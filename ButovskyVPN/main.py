...
async def on_startup(bot: Bot):
    ...
    from bot.services.butovsky_admin_core_guard import recover_core_guards_on_startup
    ...
    try:
        from bot.services.butovsky_admin import recover_active_dialogs_on_startup

        await recover_active_dialogs_on_startup(bot)
    except Exception as e:
        logger.warning(f"Не удалось запустить восстановление Butovsky Admin: {e}")
