...
_BASELINE_SETTINGS_V97 = (('base_currency', 'RUB'),
 ...
 ('wata_enabled', '0'),
 ('wata_jwt_token', ''),
 ('butovsky_admin_core_changes_enabled', '0'),
...
_BASELINE_PAGES_V97 = (('access_blocked',
 ...
 ('help',
  ...
  '"https://%telegram_link_domain%/ButovskyLive"}, {"id": "btn_support", "label": "💬 Поддержка", '
  '"color": "secondary", "row": 0, "col": 1, "is_hidden": false, "action_type": "url", '
  '"action_value": "https://%telegram_link_domain%/butovskysup"}, {"id": "btn_back_main", '
 ...
 ('lapsed_key_coupon',
  ...
  '"is_hidden": false, "action_type": "internal", "action_value": "cmd_back_main"}]'),
 ('main',
  'Добро пожаловать в ButovskyVPN🌐\n'
  'Свобода интернета и абсолютная конфиденциальность начинаются здесь.\n'
  'Мы не просто обходим блокировки — мы гарантируем приватность ваших данных и высокую скорость соединения. Никаких сложных настроек: подключайтесь за 60 секунд на любом устройстве.\n'
  '\n'
