...
async def show_wata_management_menu(callback: CallbackQuery, state: FSMContext):
    ...
    text = (
        ...
        "• <b>Новостной канал:</b> Указать ссылку на ваш новостной канал.\n\n"
        "<b>2. Верификационный платёж (разовый):</b>\n"
        "• Стандарт: 500$ (50.000₽)\n"
        "• <b>По рекомендации ButovskyVPN: 150$ (15.000₽)</b>\n"
        ...
        "• Менеджер в Telegram: @Nikita_WATA (напишите, что вы от <b>ButovskyVPN</b> для снижения платежа до 150$).\n"
...
async def show_platega_management_menu(callback: CallbackQuery, state: FSMContext):
    ...
    text = (
        ...
        "2. Сообщите менеджеру, что вы подключаете ButovskyVPN — получите скидку на подключение.\n"
