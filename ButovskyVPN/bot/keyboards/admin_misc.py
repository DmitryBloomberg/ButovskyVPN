...
def admin_main_menu_kb() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            text='🛠 Кастомизация ButovskyVPN',
            callback_data='admin_butovsky_customization',
            style='primary',
        )
    )
    builder.row(
...
def admin_logs_menu_kb() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text='📤 Отправить в Butovsky Admin', callback_data='admin_send_log_to_butovsky'))
