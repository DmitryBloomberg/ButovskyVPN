...
async def show_author_support(callback: CallbackQuery):
    ...
    developer_link = build_telegram_link('DmitryBloomberg')

    text = (
        "👤 <b>Автор и поддержка</b>\n\n"
        f"<b>Разработчик</b>: <a href=\"{developer_link}\">DmitryBloomberg</a>\n\n"
        "<b>Поддержка</b>: <a href=\"https://t.me/butovskysup\">@butovskysup</a>\n\n"
        "<b>Канал</b>: <a href=\"https://t.me/ButovskyLive\">ButovskyLive</a>"
    )
